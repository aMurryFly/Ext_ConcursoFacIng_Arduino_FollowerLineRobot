/*
 * Obtenido de
 * http://mertarduinotutorial.blogspot.mx/2016/12/arduino-project-tutorial-12-line.html
 * LIBRERIAS OBTENIDAS DE
 *  
...
AF_DCMotor motor2(4, MOTOR12_1KHZ ); //create motor #4 using M4 output on Motor Drive Shield, set to 1kHz PWM frequency
...
#define M1_minumum_speed 200  //minimum speed of the Motor1
#define M2_minumum_speed 200  //minimum speed of the Motor2
...
unsigned char whiteLine=1;    //Este argumento puesto en 1 hace que readLine se configure para líneas blancas sobre fondos negros
int position = qtrrc.readLine(sensors,true,true); //get calibrated readings along with the line position, refer to the QTR Sensors Arduino Library for more details on line position.
//True,true para que siga la linea blanca
